 ...
 */
public class ViewDragHelperNew {
    private static final String TAG = "ViewDragHelperNew";
     ...
     */
    public static ViewDragHelperNew create(ViewGroup forParent, Callback cb) {
        return new ViewDragHelperNew(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static ViewDragHelperNew create(ViewGroup forParent, float sensitivity, Callback cb) {
        final ViewDragHelperNew helper = create(forParent, cb);
     ...
     * @param forParent Parent view to monitor
     */
    private ViewDragHelperNew(Context context, ViewGroup forParent, Callback cb) {
        if (forParent == null) {
