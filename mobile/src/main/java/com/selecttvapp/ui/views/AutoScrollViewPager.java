...
public class AutoScrollViewPager extends ViewPager {
    ...
    private ViewPagerSpeedScroller scroller = null;
    ...
    public void setScrollDuration(int scrollFactor) {
        scroller.setDuration(scrollFactor);
    }
    ...
    private void setViewPagerScroller() {
        try {
            ...
            scroller = new ViewPagerSpeedScroller(getContext(), (Interpolator) interpolatorField.get(null));
